...
//        });
    ...
    public void addUser(User user){
        ...
        mDatabase.child("users").child("userID").setValue("nghiatnh1");
        mDatabase.child("users").child("Password").setValue("nghiatnh1122");
...
//                                objUser.setCusID(jsonObject.getInt("cus_id"));
//                                objUser.setFullName(jsonObject.getString("fullname"));
//                                objUser.setUserName(jsonObject.getString("user"));
//                                objUser.setPassWord(jsonObject.getString("pass"));
